...
class edicion():
    def __init__(self, controlador):
        ...
        self.root.title("Editar productos")
        self.root.geometry("800x600")

        contenedor_principal = tk.Frame(self.root, bg="#ffcccb", padx=20, pady=20)
    ...
    def crear_widgets(self, contenedor_principal, fuente):
        ...
        tk.Button(contenedor_principal, text="Accion", command=lambda: self.seleccionar_categoria("Accion"), font=fuente, bg="#ffcccb").grid(row=4, column=1, pady=5, sticky="ew")
    ...
    def guardar_producto(self):
        ...
        if ID and nombre and cantidad and ventas and categoria:
            try:
                ...
                messagebox.showinfo("Edicion Exitosa", "Producto editado correctamente.")
                self.root.destroy()
