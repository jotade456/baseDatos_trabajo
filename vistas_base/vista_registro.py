...
class abrir_registro_producto:
    def __init__(self, controlador):
        ...
        self.registro_ventana.geometry("450x450")
        self.registro_ventana.configure(bg="#e0e0e0")

        fuente = ("Arial", 12)
        self.categoria = tk.StringVar()

        contenedor_principal = tk.Frame(self.registro_ventana, bg="#ffffff", padx=20, pady=20, relief="raised", bd=2)
    ...
    def crear_widgets(self, contenedor_principal, fuente):
        ...
        tk.Button(contenedor_principal, text="Guardar Producto", command=self.guardar_producto, font=("Arial", 12, "bold"), bg="#ff4500", fg="white", bd=0, activebackground="#ff6347").grid(row=7, column=0, columnspan=2, pady=15, sticky="ew")
